...
class Refacciones(Base):
    ...
    ID_refacciones = Column(Integer, primary_key=True, autoincrement=True)
    ...
    def __init__(self, nombre, modelo, cantidad, costo):
        self.NombreRefacciones = nombre
        self.Modelo = modelo
...
def obtener_contenido():
    return session.query(
        Contenido.ID_Servicios,
        Contenido.ID_Refacciones
    )